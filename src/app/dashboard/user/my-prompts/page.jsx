                ...
                {isLoading ? (
                    ...
                    <div className="bg-[#0c101c] rounded-2xl border border-zinc-800/80 shadow-2xl p-12 md:p-20 flex flex-col items-center justify-center text-center">
                        ...
                        <p className="text-zinc-400 max-w-md mb-8 text-sm md:text-base leading-relaxed">
                            You haven't created any prompts yet. Start sharing your AI expertise with the marketplace! Remember, as a free user, you can publish up to 3 prompts.
                        </p>

                        {/* Link changed for User dashboard */}
                        <Link href="/dashboard/user/add-prompt">
                            <Button
                                className="bg-[#8B5CF6] text-white font-semibold hover:bg-[#7C3AED] transition-all shadow-[0_0_20px_rgba(139,92,246,0.3)] hover:scale-105 rounded-xl px-8 py-6 text-base"
                    ...
                    /* 📊 Data Table: Shows if prompts exist */
                        ...
                        <Table>
                            <Table.ScrollContainer>
                                <Table.Content aria-label="My Prompts Table" className="min-w-[1000px]">
                                    ...
                                    <Table.Header>
                                        <Table.Column isRowHeader id="title" className="text-zinc-400 font-semibold bg-[#121626] border-b border-zinc-800 text-center">
                                            TITLE
                                        </Table.Column>
                                                ...
                                                <Table.Row key={prompt._id} id={prompt._id} className="border-b border-zinc-800/30 hover:bg-[#121626]/50 transition-colors">
                                                    ...
                                                    <Table.Cell>
                                                        <div className="flex justify-center">
                                                            <Chip
                                                                size="sm"
                                                                className="bg-[#1f1a36] text-[#a78bfa] border border-[#2e235e] font-semibold px-3 py-4 text-[11px] tracking-wider uppercase rounded-full"
                                                            >
                                                    ...
                                                    <Table.Cell>
                                                        <div className="flex items-center justify-center gap-2">
                                                            ...
                                                            <Tooltip content="Delete" placement="top" className="bg-[#2a131c] text-danger text-xs border border-danger/20">
                                                                <Button isIconOnly size="sm" className="bg-[#2a131c] border border-danger/20 text-danger hover:bg-danger hover:text-white transition-colors rounded-lg">
                                                                    <Trash2 size={16} />
                                                                </Button>
                                                            </Tooltip>
                                                        </div>

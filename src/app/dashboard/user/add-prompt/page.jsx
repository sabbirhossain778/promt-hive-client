...
export default function UserAddPromptPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (user?.plan === "free") {
            try {
                const currentCount = await getUserPromptCount(user.id);
                
                if (currentCount >= 3) {
                    toast.error("Free Limit Reached! You can only add 3 prompts. Please upgrade to Premium.", {
                        autoClose: 5000,
                    });
                ...
                toast.error("Failed to verify account limits. Please try again.");
                setIsSubmitting(false);
                return;
            }
        }
            ...
            <div className="max-w-3xl mx-auto bg-[#0B1120] border border-zinc-900 rounded-xl p-8 shadow-2xl">
                ...
                <div className="border-b border-zinc-800 pb-6 mb-8 flex items-start justify-between">
                    ...
                    <div className="flex flex-col items-end gap-2">
                        <div className="inline-flex items-center gap-2 bg-zinc-900/50 border border-zinc-800 rounded-lg px-3 py-1.5 text-xs text-zinc-400">
                        ...
                        <div className="flex flex-col space-y-4">
                            <div className="space-y-1">
                                ...
                                <span className="text-zinc-500 text-sm block">
                                    Private prompts are locked behind Premium subscriptions.
                                </span>
                            </div>
